    ...
    return (
        ...
        >
            ...
            >
                <hr />
                <button
                    className="mt-2 flex w-full justify-start rounded-md p-2 transition-all hover:bg-lightHover"
                ...
                <button
                    className="flex w-full justify-start rounded-md p-2 transition-all hover:bg-lightHover"
