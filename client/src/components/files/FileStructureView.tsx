        ...
        <div onClick={handleClickOutside} className="flex flex-grow flex-col">
            <div className="view-title flex justify-between">
                ...
                <div className="flex gap-2">
                    <button
                        className="rounded-md px-1 hover:bg-lightHover"
...
function Directory({
    ...
    return (
        <div className="overflow-x-auto">
            <div
                className="flex w-full items-center rounded-md px-2 py-1 hover:bg-lightHover"
...
const FileMenu = ({
    ...
    return (
        <div
            className="absolute z-10 w-[150px] rounded-md border border-lightHover bg-light p-1"
            style={{
                top,
                left,
            }}
        >
            <button
                ...
                className="flex w-full items-center gap-2 rounded-md px-2 py-1 hover:bg-lightHover"
            >
            ...
            <button
                ...
                className="flex w-full items-center gap-2 rounded-md px-2 py-1 text-danger hover:bg-lightHover"
            >
                <MdDelete size={20} />
                Delete
            </button>
